...
- During the final deployment, I encountered Server Error 500.
            - Replace "login" to "account_login" in base.html so it redirects to login page upon sign out.

## Existing Bugs

- Overall, logs look clear and effective.
...
## Credits
- Code Institutes I Think Therefore I Blog was a guide to help set up the enviroment and the final deployment details.
- Three Lions project ReadMe file was used as a pettern https://github.com/ConRdav/pp4-three-lions/blob/main/README.md?plain=1
